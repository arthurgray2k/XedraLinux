...
verify_environment() {
    ...
    if [[ ! -f "${ISO_PATH}" ]]; then
        ...
        echo "  scp builder@192.168.122.180:~/XedraLinux/output/xedra-0.4.3-amd64.iso ${REPO_ROOT}/output/"
        echo "  (or for minimal: scp builder@192.168.122.180:~/XedraLinux/output/xedra-0.4.3-minimal-amd64.iso ${REPO_ROOT}/output/)"
        exit 1
    fi
